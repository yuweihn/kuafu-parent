<template>
	<el-dialog title="编辑基础参数" :visible.sync="editFormVisible" width="500px" :close-on-click-modal="true" v-drag>
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click.native="editSubmit" :loading="editLoading" v-hasPerm="['basic.update']">提交</el-button>
		</div>
	</el-dialog>
</template>
			...
			editSubmit: function() {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						this.$axios.post(this.$global.baseUrl + '/basic/update', params).then((res) => {
