<template>
	<el-dialog title="编辑负载均衡参数模板" :visible.sync="editFormVisible" width="500px" :close-on-click-modal="true"
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click.native="editSubmit" :loading="editLoading" v-hasPerm="['upstream.param.template.update']">提交</el-button>
		</div>
	</el-dialog>
</template>
			...
			editSubmit: function() {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						this.$axios.post(this.$global.baseUrl + '/upstream/param/template/update', params).then((res) => {
