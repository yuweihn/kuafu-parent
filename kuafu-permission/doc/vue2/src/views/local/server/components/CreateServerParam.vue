<template>
	<el-dialog title="新增反向代理参数" :visible.sync="addFormVisible" width="500px" :close-on-click-modal="true"
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click.native="addSubmit" :loading="addLoading" v-hasPerm="['server.param.create']">提交</el-button>
		</div>
	</el-dialog>
</template>
			...
			addSubmit: function() {
				this.$refs.addForm.validate((valid) => {
					if (valid) {
						...
						this.$axios.post(this.$global.baseUrl + '/server/param/create', params).then((res) => {
