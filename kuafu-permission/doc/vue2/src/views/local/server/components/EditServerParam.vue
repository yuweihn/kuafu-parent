<template>
	<el-dialog title="编辑反向代理参数" :visible.sync="editFormVisible" width="500px" :close-on-click-modal="true"
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click.native="editSubmit" :loading="editLoading" v-hasPerm="['server.param.update']">提交</el-button>
		</div>
	</el-dialog>
</template>
			...
			editSubmit: function() {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						this.$axios.post(this.$global.baseUrl + '/server/param/update', params).then((res) => {
