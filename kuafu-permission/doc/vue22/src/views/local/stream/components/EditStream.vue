<template>
	<el-dialog title="编辑Stream参数" :visible.sync="editFormVisible" width="500px" :close-on-click-modal="true" v-drag>
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click.native="editSubmit" :loading="editLoading" v-hasPerm="['stream.update']">提交</el-button>
		</div>
	</el-dialog>
</template>
			...
			editSubmit: function() {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						this.$axios.post(this.$global.baseUrl + '/stream/update', params).then((res) => {
