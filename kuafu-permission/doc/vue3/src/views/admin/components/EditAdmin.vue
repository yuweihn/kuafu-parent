	...
	<el-dialog title="编辑管理员" v-model="formVisible" width="450px" :close-on-click-modal="true" append-to-body draggable>
		<el-form :model="editForm" label-width="90px" :rules="formRules" ref="editFormRef">
			...
			<el-form-item label="性别" prop="gender">
				<el-select v-model="editForm.gender" placeholder="请选择" clearable filterable style="width: 150px">
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click.native="editSubmit" :loading="loading" v-if="hasPerm(['sys.admin.update'])">提交</el-button>
		</div>
	</el-dialog>
</template>
