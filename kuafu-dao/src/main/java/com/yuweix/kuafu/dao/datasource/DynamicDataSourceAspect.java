...
public class DynamicDataSourceAspect extends DataSourceAspect {
     ...
     */
    @Pointcut("(!execution(* com.yuweix.kuafu.sharding.Shardable+.*(..))) && (@within(com.yuweix.kuafu.dao.datasource.DataSource) || @annotation(com.yuweix.kuafu.dao.datasource.DataSource))")
    public void change() {
